 ...
 */
public class ArendPrim extends Entity {
    ...
    public ArendPrim(int id, String phoneNumber, String fullName, Date date, int costUah, int costUsd,
                     String common, String district, String addresses, String rentOrSell,
                     String kindOfRoom, String typeOfObject, String location, String numOfFloors,
                     String square, String numOfRooms, String condition, String heating) {
